...
const ConfirmModal = ({ display, toggle, handleApproveItem }) => {
    ...
    return (
        <Modal isOpen={display} onRequestClose={toggle} style={customStyles} ariaHideApp={false}>
            ...
            <ModalContentWrapper>
                Bạn có chắc muốn duyệt đơn hàng?
            </ModalContentWrapper>
            
            <ModalButtonWrapper>
                <ModalButton color="blue" onClick={handleApproveItem}>Xác thực</ModalButton>
